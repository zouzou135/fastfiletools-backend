...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Volumes/Batti5a/website projects/fastfiletools-backend/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Volumes/Batti5a/website projects/fastfiletools-backend/public/storage',
...
'session.http_only','session.same_site','session.partitioned','image.driver','image.options.autoOrientation',
'image.options.decodeAnimation','image.options.blendingColor','image.options.strip','ide-helper.filename','ide-helper.models_filename',
